...
const LINE_NUMBER_CLASSES = cn(
  ...
  "before:mr-4",
  "before:text-right",
  "before:text-oklch(0.556 0 0)/50 dark:before:text-oklch(0.708 0 0)/50",
  "before:font-mono",
  "before:select-none",
);
...
export const CodeBlockContainer = ({
  ...
  <div
    className={cn(
      "group relative w-full overflow-hidden rounded-md border border-oklch(0.922 0 0) bg-oklch(1 0 0) text-oklch(0.145 0 0) dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.145 0 0) dark:text-oklch(0.985 0 0)",
      className,
    )}
...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      "flex items-center justify-between border-b bg-oklch(0.97 0 0)/80 px-3 py-2 text-oklch(0.556 0 0) text-xs dark:bg-oklch(0.269 0 0)/80 dark:text-oklch(0.708 0 0)",
      className,
    )}
    {...props}
  >
